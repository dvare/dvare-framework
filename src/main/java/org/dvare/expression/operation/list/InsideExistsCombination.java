 ...
 * @since 2016-06-30
 */
@Operation(type = OperationType.BOTH_INSIDE_EXISTS_COMB)
public class InsideExistsCombination extends Match {
    private static final Logger logger = LoggerFactory.getLogger(InsideExistsCombination.class);


    public InsideExistsCombination() {
        super(OperationType.BOTH_INSIDE_EXISTS_COMB);
    }
