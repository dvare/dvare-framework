...
public class MinTest extends TestCase {
    ...
    public void testApp() throws ExpressionParseException, InterpretException {
        ...
        Expression aggregate = factory.getParser().fromString("self.A0 := data.V1 -> minimum ()", aggregationTypes, validationTypes);
    ...
    public void testApp1() throws ExpressionParseException, InterpretException {
        ...
        Expression expression = factory.getParser().fromString("[1.0,9.0,5.0] -> minimum () = 1", new ContextsBinding());
